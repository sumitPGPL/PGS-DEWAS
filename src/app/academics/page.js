  ...
  return (
    <>
        ...
        >
          <div className="w-full p-4 relative">
            ...
            <div className="flex space-x-4 mt-20">
              <button
                className="bg-white hover:bg-gray-300 text-[#75b6e5] font-bold py-2 px-4 rounded "
                onClick={() => {
      ...
      <div className="min-h-100 p-10 flex justify-center items-center flex-col mt-12">
        <h1
          className=" text-white text-2xl font-solid flex justify-center   bg-[#75b6e5] rounded-xl p-2
           "
        >
          Our Feature
        </h1>
