            ...
            <>
                <main className=" w-full flex flex-col justify-center  p-5  bg-cover bg-center" style={{ backgroundImage: "url('/MessageSvg.svg')" }}>
                    <div className='w-11/12 mx-auto h-80 flex justify-center items-center rounded-lg bg-cover bg-center '>
                        <h1 class="text-5xl text-[#3f80cf] font-extrabold dark:text-white text-center p-5">Staff Support </h1>
                    ...
                    <div className="container mx-auto my-4 px-4 lg:px-20" id='msgContainer'>
                        <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="my-2 w-1/2 lg:w-1/4">
                                <button onClick={handleSubmit} className="uppercase text-sm font-bold tracking-wide hover:bg-[#376dbe] active:bg-green-800 bg-[#75b6e5] text-gray-100 p-3 rounded-lg w-full 
                            ...
                            <div className="flex flex-col text-black">
                                ...
                                <div className="flex my-4 w-2/3 lg:w-1/2">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-gray-400">BHAWARASALA , BEHIND ARVINDO REVATI, Sanwer Rd, Dewas, Madhya Pradesh 453555</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex my-4 w-2/3 lg:w-1/2">
                                    <a href="https://www.google.com/maps/search/pratibha+global+school+Dewas/@22.8001571,75.8378225,17z?entry=ttu" target="_blank" rel="noreferrer" className="rounded-full bg-white h-8 w-8 inline-block mx-1 text-center pt-1">
