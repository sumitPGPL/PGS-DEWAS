    ...
    <Container className="flex">
      <Container className="md:w-1/2 p-11" size="custom">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p>
            You have reached the corner of the universe. The page you requested could not be found.
            Don't worry and return to your destination.
          </p>
          <Container size="custom" className="flex gap-5">
            <Button btnType='secondary' onClick={handleHome}>Home</Button>
