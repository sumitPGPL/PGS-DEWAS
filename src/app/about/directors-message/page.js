  ...
  return (
    ...
    <div className="w-11/12 flex flex-col justify-center items-center mt-9">
        ...
        <AboutMessageCard
            ...
            As the Director, I'm thrilled to welcome our students, parents, and staff to a promising academic year in Dewas, Madhya Pradesh. Our commitment to fostering excellence across Pre-Primary to Higher-Secondary levels remains unwavering. Let's embark on this educational journey together, nurturing minds, and shaping futures. Wishing all a year filled with growth, achievements, and memorable learning experiences."
            name="Mr. Suprabhat Chouksey"
            post="Managing Director"
            place="Bhawarsala Dewas"
        />
