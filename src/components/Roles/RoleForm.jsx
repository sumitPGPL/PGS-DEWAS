...
export default function RoleForm() {
  ...
  return (
    <div className="p-1 max-w-2xl mx-auto">
      ...
      <div className="mt-6">
        <h3 className="text-lg font-medium bg-[#75b6e5] p-4 text-center text-white">
          Add Role
        </h3>
      </div>
      <form onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 gap-y-6">
        ...
        <div className="flex justify-end">
          ...
          <button
            type="submit"
            className="ml-3 group relative w-32 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#75b6e5] hover:bg-[#376dbe] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            SAVE
          </button>
        </div>
