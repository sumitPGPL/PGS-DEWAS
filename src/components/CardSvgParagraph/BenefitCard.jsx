    ...
    return (
        <>
            <div className='w-full  flex-col justify-start items-start inline-flex relative mt-10 '>
                ...
                <div className="self-stretch md:h-56 lg:h-56 sm:h-64 px-3 pl-4 pt-14 rounded-lg pb-10 bg-bgreen  border-2 border-black flex-col justify-start items-start gap-4 flex shadow-[5px_5px_2px_2px_#57b4d9]" style={{ backgroundImage: "url('/greenBg.svg')" }}
                >
