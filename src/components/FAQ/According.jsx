...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="mb-8 w-full  rounded-lg border-2 border-black  dark:bg-dark-2  sm:p-8 lg:px-6 md:px-8" style={{ backgroundColor: backgroundColor }} onClick={() => handleToggle()}>
      <button
      ...
      <div
        className={`pl-10  duration-200 ease-in-out ${active ? "block" : "hidden"
          }`}
      >
