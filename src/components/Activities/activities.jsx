...
const UserPage = ({ clientDetails }) => {
  ...
  const { images = [], sectionTitle, sectionDescription, videoUrl ,backgroundImage,headTitle,headDescription } = clientDetails;
    ...
    <div>
      ...
      <section className="bg-gray-100 py-16">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl text-center font-bold mb-4">{sectionTitle}</h2>
      ...
      <section className="py-20 ">
        <div className="max-w-4xl mx-auto px-6 ">
          <div className="relative rounded-lg" style={{ paddingBottom: '56.25%', height: 0 }}>
            <iframe
