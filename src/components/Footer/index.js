              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <Link
                    ...
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    Admission Contact: Mobile No. 7024104143, 9109999593, 07272400777
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="text-gray-700 transition hover:opacity-75"
                  >
                  Email: head@mp042cisce.org <br/>
                  Email: staff@mp042cisce.org
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    ...
                    className="text-gray-700 transition hover:opacity-75"
                  >
                    Address: Ganga Nagar, Near kela devi Square, Dewas 455001
                  </Link>
                </li>
              </ul>
            </div>
