    ...
    <>
      ...
      <div>
          ...
          <div className="bg-black text-white">
            <div className="flex items-center justify-between p-4">
             ...
             <a>{svgIcon}</a> */}
              ...
              {/* Login button */}
              <div className="flex">
                <Link className="text-xs px-4 py-2 leading-none rounded-full hover:bg-[#a2d1ee] hover:text-black border-2" href='/admin/login' onClick={handleStuffLogin}>
          ...
          <div className="w-full h-[20%] bg-white flex justify-center">
            <div className="container flex flex-col md:flex-row justify-between w-full md:w-[90%] p-5 gap-10 items-center">
              ...
              <div className="md:w-1/2 flex flex-col justify-center text-center">
                <h5 className="text-[#376dbe] text-2xl md:text-3xl font-extrabold">PRATIBHA GLOBAL SCHOOL DEWAS</h5>
        ...
        <div className="lg:flex justify-center max-w-full content-center hidden md:flex  w-full ">
          <div
            className={`bg-[#bee3f9] h-12 rounded-b-lg flex justify-around w-[100%]  text-center ${isMenuOpen ? 'flex-col' : ''
          }`}
          >
                          ...
                          <ul className="">
                            {values.map((value, index) => (
                              <li key={index} className="py-2">
                                ...
                                <div onClick={() => handleSidebarItemClick(value.path)} className='p-3 shadow-md rounded-lg bg-[#e5f2f9] text-blue-600'>
                                  {value.displayName}
                                </div>
                              </li>
                            ))}
