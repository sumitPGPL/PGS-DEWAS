        ...
        <>
          ...
          >
            <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto">
              <div className="flex flex-col justify-start gap-4 text-center">
                <p className="py-2 text-2xl text-[#227da7] font-medium">
                  CONTACT US
                </p>
                <h1 className="md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold">
                  Feel Free{" "}
                  <span className="text-[#227da7]">
                    <br></br>To{" "}
                  </span>{" "}
                  <span className="text-[#227da7]">
                    <br></br>Connect
          ...
          <div className="flex justify-center items-center w-screen bg-white">
            ...
            >
              <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                ...
                <div className="my-2 w-1/2 lg:w-1/4">
                  <button
                    ...
                    className="uppercase text-sm font-bold tracking-wide hover:bg-[#92cee7] active:bg-green-800 bg-[#57b4d9] text-gray-100 p-3 rounded-lg w-full 
              ...
              <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-[#e5f2f9] rounded-2xl">
                <div className="flex flex-col text-black">
                  ...
                  <div className="flex my-4 w-2/3 lg:w-1/2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-gray-400">
                        Address: Ganga Nagar, Near kela devi Square, Dewas
                        455001
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex my-4 w-2/3 lg:w-1/2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-gray-400">
                        Admission Contact: 7024104143, 9109999593, 07272400777
                      </p>
                    </div>
                    <div className="flex flex-col">
                      ...
                      <p className="text-gray-400">
                        ...
                        head@mp042cisce.org staff@mp042cisce.org
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex my-4 w-2/3 lg:w-1/2">
                    <a
                      href="https://www.google.com/maps/search/pratibha+global+school+Dewas/@22.8001571,75.8378225,17z?entry=ttu"
                      target="_blank"
                      rel="noreferrer"
