    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <h1 className='font-extrabold text-5xl text-black text-center py-8'>Careers</h1>
                ...
                <p className='font-bold text-4xl p-5 text-black text-center'><span className='text-transparent bg-clip-text bg-gradient-to-r to-[#3f80cf] from-[#75b6e5]'>Work Together&nbsp;</span>to Make Change ..!</p>
            </div>
                        ...
                        <div className="flex flex-col justify-between border-solid border-2 border-orange-100 p-10 shadow-2xl ">
                            <div className="flex justify-between items-center sm:flex justify-between items-center flex-wrap ">
                                ...
                                <div className='flex gap-5 '>
                                    <span className="bg-[#bee3f9] rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl max-w-full"> Remote </span>
                                    <span className="bg-[#bee3f9] rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl ">Full Time </span>
                                </div>
                            </div>
                            <div className="text-sm text-gray-500 flex space-x-1 items-center">
                                ...
                                <span className='flex my-5 flex-wrap'>
                                    {career.skills.map((skill, skillIndex) => (
                                        <div key={skillIndex} className="bg-[#75b6e5] uppercase text-white text-sm px-4 py-1 font-bold shadow-xl">
                                            {skill}
                                        </div>
                                    ))}
                                </span>
