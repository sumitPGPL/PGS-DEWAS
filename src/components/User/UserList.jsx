                ...
                <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3 text-xs">
                    <span
                      class={`px-2 py-1 font-semibold leading-tight   ${
                        user.isActive
                          ? "bg-[#e5f2f9] text-[#376dbe]"
                          : "bg-red-700 text-white"
                      } rounded-full dark:${
                        user.isActive ? "bg-[#376dbe]" : "bg-red-700"
                      } dark:text-[#e5f2f9]`}
                    >
                  ...
                  <td className="px-4 py-3 text-xs">
                    <button
                      ...
                      className="bg-[#e5f2f9] hover:bg-[#376dbe] hover:text-white px-3 py-1 font-semibold leading-tight text-[#376dbe]"
                    >
                      Edit
                    </button>
                    <button
