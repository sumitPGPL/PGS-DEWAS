...
const CounterWidget = ({ initialValue = 0, targetValue = 10, speed = 100, textColor = 'black', bgColor = 'white', title = 'Counter Widget' }) => {
    const count = useAutoIncrement(initialValue, targetValue, speed);
    return (
        <div className={`py-3 self-stretch text-black text-2xl font-bold    rounded-md `}>
            +{count}
        </div>
    );
};
