            ...
            <div className='w-full mt-10 flex flex-col justify-center items-center'>
                ...
                <div className='w-full md:w-11/12 lg:w-10/12  mt-4 p-4'>
                    <div className='w-full grid lg:grid-cols-5 md:grid-cols-5 md:gap-5  lg:gap-5 grid-cols-1 '>
                        ...
                        <AboutManagementCard img="/Mgt/principal.png" name="Mrs. Sapna Jain" post="Principal (Pratibha Global School, Dewas)" link="/about/principals-message" />

                    </div>
                </div>
                <button className='bg-white border-2 border-tgreen p-3 mt-5 rounded-md hover:bg-tgreen' onClick={() => { router.push('/about/school-staff') }}>View Our Staff</button>
