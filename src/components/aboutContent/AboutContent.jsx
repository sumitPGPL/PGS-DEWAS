...
const About = () => {
  ...
  const [cards, setCards] = useState([
    {
      name: "ms. Ambika Dwivedi",
      image: "/staff/AmbikaDwivedi.jpg",
    ...
    {
      name: "Mr. Sachin Tiwari",
      image: "/staff/Sachin Sir.jpg",
      qualification: "M.Sc.(Mathematics) B.Ed",
      description: "Mr. Sachin Tiwari is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable."
    },
    {
      name: "Ms. Neeta Khute",
      image: "/staff/Neetakhute.jpg",
      qualification: "B.Com B.Ed",
      description: "Ms. Neeta khute is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable."
    },
    {
      name: "Ms. Smita Das",
      image: "/staff/DasMam.jpg",
      qualification: "BA, Montessori Trained",
      description: "Ms. Sarah is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable."
    },
  ...
  const sliderImage = [
    ...
    },
    {
      id: 6,
      url:
        "/gallarySlider/jpeg-optimizer_PGS_0623-min.JPG"
    }
  ];
      ...
      <div className='w-full bg-white py-10 bg-cover ' style={{ backgroundImage: "url('/Cloudy.svg')" }}>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
          ...
          <div className='flex flex-col justify-start gap-4 text-center'>
            <p className='py-2 text-2xl text-[#227da7] font-medium'>START TO SUCCESS</p>
            <h1 className=' py-2 md:text-6xl text-4xl font-semibold'>Welcome to    <span className='text-[#227da7]'>PGS</span> <span className='text-[#227da7]'>Learners</span> Academy
      ...
      <div className="">
        ...
        <div className="pt-6 md:p-8 text-center md:text-middle space-y-4 mb-5">
          ...
          <figcaption className="font-medium">
            ...
            {/* Buttons */}
            <div>
              <Button className="bg-[#1d6587] p-3 rounded mr-6"><Link href="/admissions">Enquire Now</Link></Button>
        ...
        {/* Section: Philosophy */}
        <div className="my-10 " style={{ background: '#00a76f' }}>
          {/* Image */}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-5 mx-5">
            {cards.map((card, index) => (
              <div key={index} className="p-[20px] bg-white rounded-xl shadow-[#3f80cf] border-gray-200 rounded-lg shadow flex-col justify-start items-start gap-[30px] inline-flex">
                ...
                <div className="self-stretch p-[20px] bg-[#e5f2f9] rounded-xl shadow-lg flex-col justify-start items-start gap-5 flex">
